      ...
      <header className="header">
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container">
            ...
            >
              Menu<i className="fa fa-bars ml-2"></i>
            </button>
            <div
            ...
            >
              ...
              <Link
                to="/login"
                className="btn btn-primary navbar-btn ml-0 ml-lg-3"
              >
                Login{" "}
              </Link>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <h1 className="hero-heading mb-0">
                Deploy website <br /> quick.
              </h1>
              <div className="row">
                <div className="col-lg-10">
                  <p className="lead text-muted mt-4 mb-4">
                    Upload your UI sketch and deploy your own website in 5
                    steps.
                  </p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="lead text-muted mt-2">
              No technical skill or knowledge required to get your website up
              and running.
            </p>
            ...
            <div className="row">
              <div className="col-lg-9 mx-auto">
                <p className="lead text mt-2">
                  We use complex AI and Deep Learning models combined with
                  stunning User Interface to makes thing <strong>simple</strong>{" "}
                  for you.
                </p>
              </div>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="row">
              <div className="col-lg-8 mx-auto">
                <p className="lead text-muted mt-2">
                  Just 5 simple steps to get your website online.
                </p>
        ...
        <div className="container">
          <div className="text-center">
            ...
            <div className="row">
              <div className="col-lg-8 mx-auto">
                <p className="lead text-muted mt-2">
                  Uses AI to create websites out of sketch files.
                </p>
                <br />
                <iframe
                  frameBorder="0"
                  width="100%"
                  height="600px"
                  src="https://cdn.knightlab.com/libs/juxtapose/latest/embed/index.html?uid=654c8bb4-4d99-11e9-8106-0edaf8f81e27"
                ></iframe>
              </div>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-lg-10">
                  <p className="lead divider-subtitle mt-2 text-muted">
                    Customize your website and then deploy it on server with
                    just one click.
                  </p>
                </div>
              </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-3 mb-5 mb-lg-0">
              ...
              <ul className="list-unstyled">
                ...
                <li>
                  {" "}
                  <a href="text.html" className="footer-link">
                    Text Page
                  </a>
                </li>
              </ul>
            ...
            <div className="row">
              <div className="col-lg-6 text-center text-lg-left">
                <p className="copyrights-text mb-3 mb-lg-0">
                  &copy; All rights reserved PeachPixel.
                </p>
              </div>
